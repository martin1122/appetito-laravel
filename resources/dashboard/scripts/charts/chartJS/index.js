    ...
    new Chart(lineCtx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderWidth          : 2,
          data                 : arrayFromString(totalUsers.dataset.total),
        }, {
          label                : 'Active',
          ...
          borderWidth          : 2,
          data                 : arrayFromString(activeUsers.dataset.active),
        }],
      },
...
function arrayFromString(arrayString) {
  let arrayStringSplit = arrayString.split(';');
  let results = [];
  arrayStringSplit.forEach(function (element) {
